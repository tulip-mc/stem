...
## ver.month = 05
## ver.day = 20
execute unless score ver.month tulip.defs matches 6 run bossbar set tulip:ver name ["",{"text":"③ ","color":"#a6e3a1"},{"text":"tulip","bold":true,"color":"#a6e3a1","font":"tulip:alternate"},{"text":" closed beta ","color":"gray"},{"text":" \u0020 [","color":"dark_gray"},{"score":{"name":"ver.year","objective":"tulip.defs"}},{"text":"."},{"score":{"name":"ver.month","objective":"tulip.defs"}},{"score":{"name":"ver.day","objective":"tulip.defs"}},{"text":"]","color":"dark_gray"}]
execute if score ver.month tulip.defs matches 6 run bossbar set tulip:ver name ["",{"text":"③ ","color":"#a6e3a1"},{"text":"t","bold":true,"color":"#f38ba8","font":"tulip:alternate"},{"text":"u","bold":true,"color":"#fab387","font":"tulip:alternate"},{"text":"l","bold":true,"color":"#a6e3a1","font":"tulip:alternate"},{"text":"i","bold":true,"color":"#74c7ec","font":"tulip:alternate"},{"text":"p","bold":true,"color":"#cba6f7","font":"tulip:alternate"},{"text":" closed beta ","color":"gray"},{"text":" \u0020 [","color":"dark_gray"},{"score":{"name":"ver.year","objective":"tulip.defs"}},{"text":"."},{"score":{"name":"ver.month","objective":"tulip.defs"}},{"score":{"name":"ver.day","objective":"tulip.defs"}},{"text":"]","color":"dark_gray"}]
# display @a
